...
urlpatterns = [
  ...
  url(r'^auth/password-reset/validate_token/', reset_password_validate_token, name="reset-password-validate"),
  url(r'^auth/password-reset/confirm/', reset_password_confirm, name="reset-password-confirm"),
  url(r'^auth/password-reset/', reset_password_request_token, name="reset-password-request"),
]
