...
class Employee(models.Model):
    ...
    subdivision = models.CharField(
        default='1', max_length=255, choices=subdivision_choices)
    payment_type = models.CharField(
        default='1', max_length=255, choices=payment_type_choices)
    ...
    profile_picture = models.ImageField(
        default=None, blank=True, null=True, upload_to="images/")
    is_active = models.BooleanField(default=True)
...
class Revenue(models.Model):
    ...
    facility = models.ForeignKey(
        Facility, default=None, blank=True, null=True, on_delete=models.CASCADE)
...
class Scan(models.Model):
    ...
    scan_type = models.CharField(
        default='1', max_length=255, choices=scan_types)
...
class SalaryDeductions(models.Model):
    deduction_choices = [
        ...
        ('5', 'Бой'),
        ('6', 'Форма'),
        ('7', 'Удержание по сверкам'),
        ('8', 'Удержание по акту списания'),
        ('9', 'Штраф'),
        ('10', '%'),
        ('11', 'Доплата'),
    ]
    ...
    deduction_type = models.CharField(
        default='1', max_length=255, choices=deduction_choices)
    employee = models.ForeignKey(Employee, on_delete=models.CASCADE)
    amount = models.IntegerField(default=0)
    date = models.DateField(auto_now=False, auto_now_add=False)
